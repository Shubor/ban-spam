...
\begin{table}[H]
\centering
\caption{Accuracy of different feature selection methods using our Na\"ive Bayes and 10-fold cross-validation for different features numbers}
\begin{tabular}{@{}l rrrrrrr@{}}
\toprule
& \multicolumn{7}{c}{\textbf{Feature Selection Method}}\\
\midrule
